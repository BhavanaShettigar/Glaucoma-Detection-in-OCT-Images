...
ImageFolder = 'C:\Users\user\Documents\MATLAB\g_may_fourteen\CombinedData'; %Path of input image 
...
Pattern = fullfile(ImageFolder, '*.jpg'); %Create full file path with file pattern i.e.,.jpg,.png
...
for k = 1 : length(Files) %Loop to total number of files in the folder 
  ...
  x=double(CannyEdgeImage);
  g1=[5,5,5; -3,0,-3; -3,-3,-3]; % N
  g2=[5,5,-3; 5,0,-3; -3,-3,-3]; % NW
  g3=[5,-3,-3; 5,0,-3; 5,-3,-3]; % W
  g4=[-3,-3,-3; 5,0,-3; 5,5,-3]; % SW
  g5=[-3,-3,-3; -3,0,-3; 5,5,5]; % S
  g6=[-3,-3,-3; -3,0,5;-3,5,5];  % SE
  g7=[-3,-3,5; -3,0,5;-3,-3,5];  % E
  g8=[-3,5,5; -3,0,5;-3,-3,-3];  % NE
...
final = OverlayImage;
dest = 'C:\Users\user\Documents\MATLAB\g_may_fourteen\OutputKirschCannyImageFolder\';
